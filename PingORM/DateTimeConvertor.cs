...
namespace PingORM
{
    ...
    public static class DateTimeConvertor
    {
        ...
        /// <summary>
        /// Converts a unix time stamp to a DateTime object in the local time zone.
        /// </summary>
        /// <param name="unixTime"></param>
        /// <returns></returns>
        public static DateTime FromUnixToLocalTime(this double unixTime)
        {
            return unixTime.FromUnixTime().ToLocalTime();
        }
        ...
        /// <param name="unixTime"></param>
        /// <returns></returns>
        public static DateTime FromUnixToLocalTime(this long unixTime)
        {
            return unixTime.FromUnixTime().ToLocalTime();
        }
